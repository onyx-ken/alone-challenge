...
<div class="certificate-container-wrapper" style="display: flex;">
    <div class="certificate-container" style="background-image: url({background});">
        <h1 class="certificate-title" style="display: flex;">도전장</h1>
        <div class="certificate-sub" style="display: flex;">
            <FistIcon width="72" height="72" />
        </div>
        <div class="certificate-sub" style="display: flex;">
            <h2 class="certificate-nickName" style="display: flex;">{nickName}</h2>
        </div>
        <div class="certificate-sub" style="display: flex;">
            <p class="certificate-dec" style="display: flex;">"{challengeDescription}"</p>
        </div>
        <div class="certificate-sub" style="display: flex;">
            <p class="certificate-date" style="display: flex;">{startDate} ~ {endDate}</p>
        </div>
        {#if isSuccess !== null}
            <div class="mt-8">
                {#if isSuccess}
